...
abstract class AuctionTableModel extends AbstractTableModel
{  public AuctionTableModel(ResultSet aResultSet)
   {  rs = aResultSet;
      try
      {  rsmd = rs.getMetaData();
      }
...
class ScrollingAuctionTableModel extends AuctionTableModel
{  public ScrollingAuctionTableModel(ResultSet aResultSet)
   {  super(aResultSet);
   }
...
class CachingResultSetTableModel extends AuctionTableModel
   ...
   {  if (evt.getSource() == tableNames)
      {  // show the selected table from the combo box
         ...
         {  String tableName
            ...
            if (SCROLLABLE)
               model = new ScrollingAuctionTableModel(rs);
            else
